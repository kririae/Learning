...
对于$u \rightarrow v$，设$siz[x]$为$x$的子树大小。$d[u] + siz[u] - siz[v] = d[v]$。首先考虑叶子结点，$siz[u] = 1$，且$siz[v]$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTQwNDEzMTMsMTQ0ODEwMTkyOSwxNj
Q3NjIwMjM1LC0xMDg2NjM1ODEzXX0=
-->