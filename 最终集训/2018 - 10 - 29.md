...
首先说暴力的解法， 没啥技巧性。枚举每条边，然后看这条边删除后是否会导致最大匹配变小。这不和新型城市化一样么...我们考虑一条边作为“最大匹配”中的必须边。如果这条$u \rightarrow v$在同一个$SCC$中，
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzYwNDIzODk3LDE0NDgxMDE5MjksMTY0Nz
YyMDIzNSwtMTA4NjYzNTgxM119
-->