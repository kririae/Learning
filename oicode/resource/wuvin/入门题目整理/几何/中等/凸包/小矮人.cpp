...
/////////////////////////////////////////////
struct point{db x,y;};
inline int sg(double a){if(a<eps&&a>-eps) return 0;return a>0?1:-1;}
...
inline bool onleft(point &o,point &a,point &b){return sg(cross(a-o,b-o))>0;} 
//------------------------------------------
int n;point p[N];
///////////////////////////////////////////库
#define tbout out
...
void tb(){
	sort(tbin+1,tbin+szin+1);szout=0;
	for(int i=1,p2=1;i<=n;i++){addpoint();}
	for(int i=n-1,p2=szout;i>=1;i--){addpoint();}
}
//------------------凸包---------------------
struct seg{
	int from,to;
