...
//////////////////////////////几何
int n,cnt,pts;
int dq[20105];int l,r;
point p2[20105];//i和i-1的交点 
seg s[20005];
point out[20105];
int solve(){
	sort(s,s+cnt);int cn2=1,cnt3=0;
...
void init(){
	scanf("%d",&n);
	s[0]=seg(0,10000,0,0);s[1]=seg(0,0,10000,0);
	s[2]=seg(10000,0,10000,10000);s[3]=seg(10000,10000,0,10000);
	for(int i=4;i<n+4;i++){
		double ax,ay,bx,by;
